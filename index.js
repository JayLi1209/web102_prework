...
const displayStr = `A total of ${raisedCard.innerHTML} is raised for ${GAMES_JSON.length} games.
 Ain't that amazing? Currently, ${unfundedGames} ${unfundedGames == 1 ? "game" : "games"} remain unfunded.
 We need your help to fund the ${unfundedGames == 1 ? "game" : "games"}!`
...
const [game1, game2] = [...sortedGames.slice(0, 2)];

// create a new element to hold the name of the top pledge game, then append it to the correct element
// do the same for the runner up item
const [name1, name2] = [game1.name, game2.name];
